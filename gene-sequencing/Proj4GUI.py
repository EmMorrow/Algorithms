...
class Proj4GUI( QMainWindow ):
	...
	def initUI( self ):
		...
		self.seq1_name.setEnabled(True) #used to be false

		self.seq1_chars		= QLineEdit('')
		self.seq1_chars.setFixedWidth(850)
		self.seq1_chars.setEnabled(True) #used to be false
		self.seq2_chars		= QLineEdit('')
		self.seq2_chars.setFixedWidth(850)
		self.seq2_chars.setEnabled(True) #used to be false
		self.seq2_name	   = QLineEdit('')
		self.seq2_name.setFixedWidth(500)
		self.seq2_name.setEnabled(True) #used to be false
